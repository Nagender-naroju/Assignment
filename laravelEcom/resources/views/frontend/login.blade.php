                ...
                <div class="review-form">
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-check">
                                        ...
                                        @if (Route::has('password.request'))
                                            <a class="btn btn-link" style="font-size: 1.5rem; color:black;text-decoration-color: azure;" href="{{ route('password.request') }}">
                    ...
                    <div class="review-form-name">
                        <div class="login-btn text-center">
                            <span class="shop-account">Dont't have an account ?<a href="{{ route('register') }}">Sign Up Free</a></span>
                        </div>
                    </div>
                </div>
            </div>
