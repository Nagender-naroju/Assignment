            ...
            <div class="container">
                <div class="header-top">
                    <div class="header-profile">
                        <a href="{{ url('/user-profile') }}"><span>Account</span></a>
                ...
                <div class="header-center">
                    ...
                    <div class="header-cart-items">
                        ...
                        <div class="header-favourite">
                            <a href="{{ url('/user-wishlist') }}" class="cart-item">
                                <span>
                        ...
                        <div class="header-cart">
                            <a href="{{ url('/user-cart')}}" class="cart-item">
                                <span>
                            ...
                            <div class="cart-submenu">
                                ...
                                <div class="cart-wrapper-section">
                                    ...
                                    <div class="cart-btn">
                                        <a href="{{ url('/user-cart') }}" class="shop-btn view-btn">View Cart</a>
